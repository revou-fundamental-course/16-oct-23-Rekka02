...
slides[sliderIndex - 11].style.display = "block";
}
...
function saveData() {
    ...
    ppsan.innerHTML = "Save @: " + showDateTime() + "<br> Nama: " + nama + "<br>Tanggal Lahir: " + tgllahir + "<br>Gender: " + selectedGender +"<br>Pesan: " + pesan 
}
